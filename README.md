...
Funcionalidades:
Tela inicial com o nome do jogo, instruções, opções de iniciar e sair;
Registro de jogadores e pontuação no arquivo ranking.txt;
Perguntas de Matemática e Cultura Geral (6 de cada tipo);
Interface gráfica organizada em pacotes ( desafiologicoe desafiologico.gui);
Utiliza conceitos de herança , polimorfismo e classes abstratas/interfaces .

Como rodar:
Abrir o projeto no NetBeans ( DesafioLogicoCriativo);
